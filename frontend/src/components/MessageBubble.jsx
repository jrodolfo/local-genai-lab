            ...
            <div className="message-bubble">
                ...
                tokens: {metadata.inputTokens ?? '?'} in / {metadata.outputTokens ?? '?'} out / {metadata.totalTokens ?? '?'} total
                        ...
                        {metadata.durationMs != null ?
                            <span>provider duration: {formatDuration(metadata.durationMs)}</span> : null}
                        {metadata.providerLatencyMs != null ?
                            <span>provider latency: {formatDuration(metadata.providerLatencyMs)}</span> : null}
