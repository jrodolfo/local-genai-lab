...
public class ChatPromptBuilder {
    ...
    private void appendResponseRules(StringBuilder builder) {
        ...
        builder.append("- When the tool output includes counts, regions, services, or bucket names, prefer those concrete facts.\n");
        builder.append("- Focus on findings and conclusions, not on tool mechanics.\n");
        builder.append("- Do not say \"using the tool\", \"commands executed\", or similar process narration unless the user explicitly asks how the result was produced.\n");
        builder.append("- Do not expose internal container or filesystem paths such as /app/... unless the user explicitly asks for artifact locations.\n");
        ...
        builder.append("- Mention generated artifacts only when it materially helps answer the current question.\n");
        builder.append("- Do not invent missing facts.\n");
        builder.append("- If the context is incomplete or ambiguous, say so explicitly.\n");
